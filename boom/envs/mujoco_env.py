...
from boom.envs.wrappers.timeout import Timeout
...
def make_env(cfg):
	...
	# env = TimeLimit(env, 1000) # Default max episode steps for other tasks
	env = Timeout(env, 1000) # Default max episode steps for other tasks
